...
import dev.redstudio.valkyrie.handlers.*;
...
public final class Valkyrie {
	...
	@Mod.EventHandler
	public static void preInit(final FMLPreInitializationEvent preInitializationEvent) {
	...
	@Mod.EventHandler
	public static void postInit(final FMLPostInitializationEvent postInitializationEvent) {
